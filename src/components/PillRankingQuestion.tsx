        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className="px-4 py-2.5 rounded-full font-medium transition-all bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-600 hover:shadow-sm"
            >
              {item}
            </button>
          );
