...
const VALORES = [
  'Liberdade, direitos individuais e autonomia',
  ...
  'Direitos humanos',
  'Paz, não-violência e instituições justas',
  'Laicidade e liberdade religiosa',
];

const PREOCUPACOES = [
  'Discriminação e ódio (racial, de género, orientação sexual, etc.)',
  'Desigualdade económica e pobreza',
  'Crise climática e degradação ambiental',
  'Perda de natureza e biodiversidade',
  'Autoritarismo e erosão democrática',
  'Desinformação, propaganda e alienação social',
  'Guerra, insegurança e violência',
];

const TEMAS = [
  'Economia, trabalho e rendimento digno',
  'Desigualdade e pobreza',
  'Saúde',
  'Educação e aprendizagem ao longo da vida',
  'Igualdade de género',
  'Serviços básicos e infraestruturas (água, energia, transportes, internet)',
  'Habitação e cidades sustentáveis',
  'Migrações e fronteiras',
  'Justiça, segurança e sistema prisional',
  'Ambiente, clima e biodiversidade',
  'Agricultura, alimentação e segurança alimentar',
  'Cultura, artes e media',
  'Tecnologia e inovação',
  'Contrato social, fiscalidade e políticas monetárias',
  'Governação e qualidade da democracia',
